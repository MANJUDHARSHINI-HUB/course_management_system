      ...
      <div className="dash-body">
       ...
       <div className="stat-grid">
        ...
        <div className="stat-card tone-teal">
         ...
         <span className="value" id="stat-ongoing-count">0</span>
        ...
        <div className="stat-card tone-brown">
         ...
         <span className="value" id="stat-completed-count">0</span>
        ...
        <div className="stat-card tone-danger">
         ...
         <span className="value" id="stat-certificates-count">0</span>
